...
<div id="wrap">
	<h2>수정하기</h2>
	<form class="modify" method="post" action="/sell/modify">
	...
	<table>
		...
		<tr>
			<td>제목</td>
			<td><input type="text" name="sTitle" required value="${board.STitle }"></td>
		</tr>
		<tr>
			<td>내용</td>
			<td><textarea rows="" cols="" name="sContent" required>${board.SContent }</textarea></td>
		</tr>
		<tr>
			<td colspan="2">
