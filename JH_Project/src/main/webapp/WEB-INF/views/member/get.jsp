...
<div id="wrap">
	...
	<div class="inner">
		<table>
			...
			<tr>
				<td>전화번호</td>
				<td><p><c:out value="${mem.MPhone}"></c:out></p></td>
			</tr>
			<tr class="address">
				<td>주소</td>
				<td>
					<p><c:out value="${mem.MAddress}"></c:out></p>
				</td>
			</tr>
			<tr>
				<td>이메일</td>
				<td><p><c:out value="${mem.MEmail }"></c:out></p></td>
			</tr>
		</table>
		<div id="button">
			<button type="submit" onclick="location.href='/member/modify'" class="btn btn-outline-primary">회원정보 수정</button>
		</div>
